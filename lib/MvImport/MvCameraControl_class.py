...
from lib.path import get_project_root
import os
# 项目根目录
project_path = get_project_root()
basedir = os.path.join(project_path,"lib","MvImport","dll","MvCameraControl.dll")
# path1 = r"C:\Users\Administrator\Desktop\MKC\untitled1\lib\MvImport\dll\MvCameraControl.dll"
# path2 = 'C:\Program Files (x86)\Common Files\MVS\Runtime\Win64_x64\MvCameraControl.dll'
MvCamCtrldll = WinDLL(basedir)
