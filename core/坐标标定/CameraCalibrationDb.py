...
class CCOperateDb(DataDb):
    """保存的参数表"""
    keys = ['name','comboBoxIndex','text','matrix'  ]
    data = {}
    table_name = 'CameraCalibrationData'
    # @classmethod
    # def insert_data(cls):
    #     """创建数据库"""
    #     globalsdynamic.db_main.create_tables('CameraCalibration', cls.keys)
    #
    # @classmethod
    # def get_names(cls):
    #     """获取主键列表"""
